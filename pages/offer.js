...
const Offer = () => {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      const trx = await NFTInstance.makeOffer(_tokenId, _price, {
        value: _price,
      }); // list our nft
                ...
                <div className="w-full md:w-2/3 md:px-5">
                  <div className="bg-white px-5 md:px-20 py-20">
                    <div className="flex">
                      <div className="w-1/2">
                        <h1 className="font-bold text-2xl mb-16 capitalize">
                          Make offer for {data.getToken.title}
                        </h1>
                      </div>
                    ...
                    <p className="mb-16 font-bold text-sm">
                      Once your make offer, You'll be the hightest.
                    </p>
                    ...
                    <div className="bg-gray-800 mb-16">
                      <input
                        className={`appearance-none bg-gray-200 text-gray-700 leading-tight focus:bg-white focus:outline-gray-400 py-3 px-4 w-4/5 ${offered}
