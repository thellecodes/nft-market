...
class Offer extends Component {
  render() {
    return (
      <section id="offer" className="lg:h-screen">
            ...
            <div className="pt-20 md:flex">
              <div className="w-full md:w-2/3 md:px-5">
                <div className="bg-white px-5 md:px-20 py-20">
                  <h1 className="font-bold text-2xl mb-16">Make Offer</h1>

                  <p className="mb-16 font-bold text-xl">
                    Once an Offer is sent, the owner will have 24 hours to
                    accept. If the Offer expires, the funds will be available in
                    your Marketplace Balance
                  </p>
