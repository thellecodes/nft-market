...
const Bid = () => {
  ...
  const getTokenBalance = async () => {
    const { NFTInstance, provider, accounts } = await isUnlocked();
    if (tokenId) {
  ...
  const onSubmit = async () => {
    console.log((walletBalance / 10 ** 18) * 1000);
  ...
  return (
    <>
      <Head>
        <title>{data ? data.getToken.title.toUpperCase() : null} - NFT</title>
      </Head>
              ...
              <div className="w-full md:w-2/3 md:px-5">
                <div className="bg-white px-5 md:px-20 py-20">
                  <div className="flex">
                    <div className="w-1/2">
                      <h1 className="font-bold text-2xl mb-16 capitalize">
                        Place a Bid for {data ? data.getToken.title : null}
                      </h1>
                    </div>
                    <div className="w-1/2 flex items-center justify-end">
                      <h6 className="font-bold text-xl mb-16 capitalize">
                  ...
                  <p className="mb-16 font-bold text-sm">
                    ...
                    the auction, and the owner have to accept the offer for you
                    to gain the nft``
                  </p>
